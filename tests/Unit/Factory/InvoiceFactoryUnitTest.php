...
class InvoiceFactoryUnitTest extends TestCase
{
    ...
    {
        $dtoOne = new InvoiceItemDTO(1, 50, 'Test-one', 100.5, '2023-1', 5);
    ...
    {
        $dtoOne = new InvoiceItemDTO(1, 50, 'Test-one', 100.5, '2023-1', 1);
        $testOne = InvoiceFactory::factoryInvoice($dtoOne, 1);
    ...
    {
        $dtoOne = new InvoiceItemDTO(1, 50, 'Test-one', 100.5, '2023-2', 1);
        $testOne = InvoiceFactory::factoryInvoice($dtoOne, 1);
    ...
    {
        $dtoOne = new InvoiceItemDTO(1, 50, 'Test-one', 100.5, '2023-3', 1);
        $testOne = InvoiceFactory::factoryInvoice($dtoOne, 1);
    ...
    {
        $dtoOne = new InvoiceItemDTO(1, 50, 'Test-one', 100.5, '2023-4', 1);
        $testOne = InvoiceFactory::factoryInvoice($dtoOne, 1);
    ...
    {
        $dtoOne = new InvoiceItemDTO(1, 50, 'Test-one', 100.5, '2023-5', 1);
        $testOne = InvoiceFactory::factoryInvoice($dtoOne, 1);
    ...
    {
        $dtoOne = new InvoiceItemDTO(1, 50, 'Test-one', 100.5, '2023-6', 1);
        $testOne = InvoiceFactory::factoryInvoice($dtoOne, 1);
    ...
    {
        $dtoOne = new InvoiceItemDTO(1, 50, 'Test-one', 100.5, '2023-2', 5);
        $testOne = InvoiceFactory::factoryInvoice($dtoOne, 1);
    ...
    {
        $dtoOne = new InvoiceItemDTO(1, 50, 'Test-one', 100.5, '2023-3', 4);
        $testOne = InvoiceFactory::factoryInvoice($dtoOne, 1);
    ...
    {
        $dtoOne = new InvoiceItemDTO(1, 50, 'Test-one', 100.5, '2023-4', 3);
        $testOne = InvoiceFactory::factoryInvoice($dtoOne, 1);
    ...
    {
        $dtoOne = new InvoiceItemDTO(1, 50, 'Test-one', 100.5, '2023-5', 2);
        $testOne = InvoiceFactory::factoryInvoice($dtoOne, 1);
    ...
    {
        $dtoOne = new InvoiceItemDTO(1, 50, 'Test-one', 100.5, '2023-6', 6);
        $testOne = InvoiceFactory::factoryInvoice($dtoOne, 1);
    ...
    {
        $dtoOne = new InvoiceItemDTO(1, 50, 'Test-one', 100.5, '2023-6', 0);
        $testOne = InvoiceFactory::factoryInvoice($dtoOne, 1);
    ...
    {
        $dtoOne = new InvoiceItemDTO(1, 50, 'Test-one', 100.5, '2024-1', 6);
    ...
    {
        $dtoOne = new InvoiceItemDTO(1, 50, 'Test-one', 100.5, '2024-2', 6);
        $testOne = InvoiceFactory::factoryInvoice($dtoOne, 10);
    ...
    {
        $dtoOne = new InvoiceItemDTO(1, 50, 'Test-one', 100.5, '2024-3', 6);
        $testOne = InvoiceFactory::factoryInvoice($dtoOne, 10);
