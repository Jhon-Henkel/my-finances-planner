...
describe('Testing the Invoice Carousel Item', () => {
    it('render component with invoice data', () => {
        ...
        expect(wrapper.html()).toContain('<div class="col-7 d-flex justify-content-start align-items-start"><span>Test 1</span></div>')
        expect(wrapper.html()).toContain('<div class="col-7 d-flex justify-content-start align-items-start"><span> Valor: R$ 10,50</span></div>')
        ...
        expect(wrapper.html()).toContain('<div class="col-7 d-flex justify-content-start align-items-start"><span>Test 2</span></div>')
        expect(wrapper.html()).toContain('<div class="col-7 d-flex justify-content-start align-items-start"><span> Valor: R$ 1,90</span></div>')
